    ...
    <section className="w-full max-w-full flex-center flex-col">
      ...
      <form onSubmit={handleSubmit} className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
        ...
        <label >
          ...
          <textarea value={post.prompt} placeholder="write your prompt here..."
          required className="form_textarea"  onChange={(e)=>setPost({
        ...
        <label >
          ...
          <input value={post.tag} placeholder="#tags"
          required className="form_input"  onChange={(e)=>setPost({
